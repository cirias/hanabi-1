...
The final score can be computed by summing the top value on each stack, with
a higher score being more desireable. Each player can see the cards of all
other players, but not their own. On each turn, a player can play a card
(without looking at it), discard a card, or give information to another player.
The goal is to play as many cards as possible in a specified order.
...
-rules
-game difficult vs size/number of cards that must be played
-human results here?
