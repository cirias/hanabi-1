...
def main():
    ...
    policies = [
        ...
        ("mini Hanabi",   mini_bins,   "guided-learned",       "C1", "sweep_best/f7/mini_trpo_ai_best.txt"),
        ("medium Hanabi", medium_bins, "guided-learned",       "C1", "sweep_best/f8/medium_trpo_ai_best.txt"),
        ("Hanabi",        bins,        "guided-learned",       "C1", "sweep_best/f9/trpo_ai_best.txt"),
        ("mini Hanabi",   mini_bins,   "static self-learned",  "C2", "sweep_best/f4/mini_trpo_staggered_best.txt"),
        ("medium Hanabi", medium_bins, "static self-learned",  "C2", "sweep_best/f5/medium_trpo_staggered_best.txt"),
        ("Hanabi",        bins,        "static self-learned",  "C2", "sweep_best/f6/trpo_staggered_best.txt"),
